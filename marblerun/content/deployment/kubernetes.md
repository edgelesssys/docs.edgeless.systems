...
While Marbles built with [Ego](content/building-services/ego.md) perform in-process attestation, other frameworks, such as [Graphene](content/building-services/graphene.md), use out-of-process attestation.
