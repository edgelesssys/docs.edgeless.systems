...
Depending on your setup you may follow the [quickstart for SGX enabled clusters](content/getting-started/quickstart-sgx.md). Alternatively, if your setup does not support SGX, you can follow the [quickstart in simulation mode](content/getting-started/quickstart-simulation.md).
...
If your cluster supports SGX, you can follow the [quickstart for clusters with SGX support.](content/getting-started/quickstart-sgx.md") \
Otherwise, please follow the [quickstart in simulation mode.](content/getting-started/quickstart-simulation.md)
